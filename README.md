...
- New Autonomous Agent -> entrer "Init" dans l'input field, clic sur submit puis run
- New Autonomous Agent -> entrer "Start" dans l'input field, clic sur submit puis run
